...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "*A reversible computation virtual machine implemented in ReScript + Deno*")
...
(define development-practices
  '((code-style
     (languages . ("Just" "PowerShell" "ReScript" "Scheme" "TypeScript"))
