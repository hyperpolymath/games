# Elixir Integration for IDApTIK Rust Core

> **Note**: This document is preserved from the `idaptik` game engine repository for
> future reference. The multiplayer game features are planned for v3.x when this
> project expands to include the asymmetric cooperative game mode.
